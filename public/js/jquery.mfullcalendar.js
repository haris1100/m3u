...
!function($) {
    ...
    CalendarApp.prototype.onEventClick =  function (calEvent, jsEvent, view) {
        var $this = this;
            ...
            form.append("<label><small>Event name:</small>:</label>");
            form.append("<div class='input-group'><input class='form-control' readonly type=text value='" + calEvent.title + "' /></div>");
            form.append("<label><small>Event Start Time:</small></label>");
            // form.append("<div ><p>" + calEvent.start.format('h:mm:ss a') + " </p></div>");
            form.append("<div class='input-group'><input class='form-control' readonly type=text value='" + calEvent.start.format('h:mm:ss a')+ "' /></div>");

            // form.append("<label><small>Event End Time:</small></label>");
            // form.append("<div ><p>" + calEvent.end.format('h:mm:ss a') + " </p></div>");
