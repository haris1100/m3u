    ...
    function loadCard(){
          $.ajax({
              ...
              success:function(response){
                 ...
                 var card="<div class=\"card ml-5 mb-3 p-3 bg-dark text-white \" style=\"width: 18rem;\">\n" +
                     "  <img  class=\"card-img-top\" src=\"./"+split[2]+".jpg\" alt=\"Card image cap\">\n" +
                     "  <div class=\"card-body\">\n" +
                     // "    <h3><u>"+response[i].heading+"</u></h3>\n" +
                     "    <p class=\"card-text\">"+response[i].text+"</p>\n" +
                     "    <a href='MyBlog/"+response[i].heading+"' onclick=\"\" class=\"btn btn-secondary\" style=\"width:100%;position: absolute; bottom:0;right:0;\">Read More</a>\n" +
                     "  </div>\n" +
                     "</div>";
...
<section class=" pt-5  pb-5"  style="background-color:  rgb(25, 117, 210)">
    <div class="container">
        <h1 class="text-center mb-5" >Blog | Get to know about our latest updates</h1>
{{--       --}}
