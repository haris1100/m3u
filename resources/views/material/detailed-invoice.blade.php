@php
    if($_SESSION['userLogined']->id==$_GET['u']) {
    $id=$_GET['i'];
               if (DB::table('invoice')->where('id', $id)->exists()) {
                   $getinvoice = DB::table('invoice')->where('id', $id)->first();
...
<head>
    ...
    <title>App Invoice | M3U editor</title>
    ...
    <link rel="stylesheet" type="text/css" href="newTemp/app-assets/css/pages/app-invoice.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
            ...
            <div class="col s12">
                <div class="container">
                    ...
                    <section class="invoice-view-wrapper section">
                        <div class="row">
                            <!-- invoice view page -->
                            <div class="col xl9 m8 s12" id="downloadThisInvoice">
                                <div class="card">
                                            ...
                                            <div class="col xl8 s12">
                                                <div class="invoice-date display-flex align-items-center flex-wrap">
                                                    <div class="mr-3">
                                                        ...
                                                        <span>{{$getinvoice->dateOfMembership}}</span>
                                                    </div>
{{--                                                    <div>--}}
...
{{--                                                <img src="newTemp/app-assets/images/gallery/pixinvent-logo.png" alt="logo" height="46" width="164">--}}
                                            </div>
                                            <div class="col m6 s12 pull-m6">
                                                <h4 class="indigo-text">M3UEditor</h4>
                                                <span>Perfect your M3U playlist</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row invoice-info">
                                            <div class="col m6 s12">
                                                <h6 class="invoice-from">Paid by</h6>
...
{{--                                                </div>--}}
                                            ...
                                            <div class="col m6 s12">
                                                ...
                                                <div class="invoice-address">
                                                    <span><a target="_blank" href="https://m3ueditor.com">M3U Editor</a></span>
                                                </div>
{{--                                                <div class="invoice-address">--}}
...
{{--                                                </div>--}}
                                                <h6 class="invoice-to">Membership period</h6>
                                                <div class="invoice-address">
                                                    <span>Start from : <u>{{$getinvoice->dateOfMembership}}</u></span>
                                                </div><div class="invoice-address">
                                                    <span>Ends in : <u>{{$getName->membershipEndsIn}}</u></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="divider mb-3 mt-3"></div>
                                        ...
                                        <div class="invoice-product-details">
                                            <table class="striped responsive-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="text-transform: capitalize;">{{$cardName->cardName}}</td>
                                                        <td>{{$getinvoice->SubscriptionType}} Subscription</td>
                                                        <td>{{$getinvoice->amount}}</td>
                                                        <td>1</td>
                                                        <td class="indigo-text right-align">${{$getinvoice->amount}}.00</td>
                                                    </tr>
                                                ...
                                                <div class="col xl4 m7 s12 offset-xl3">
                                                    <ul>
                                                        <li class="display-flex justify-content-between">
                                                            ...
                                                            <h6 class="invoice-subtotal-value">${{$getinvoice->amount}}.00</h6>
                                                        </li>
{{--                                                        <li class="display-flex justify-content-between">--}}
...
{{--                                                        </li>--}}
                                        ...
                                        <footer class="page-footer footer footer-static footer-dark gradient-45deg-purple-deep-green gradient-shadow navbar-border navbar-shadow">
                                            <div class="footer-copyright">
                                                <div class="container"><span>&copy; 2021 <a  href="https://m3ueditor.com" target="_blank">M3U editor</a> All rights reserved.</span><span class="right hide-on-small-only">software by <a target="_blank" href="https://m3ueditor.com/">M3U Editor</a></span></div>
                                            </div>
                                        </footer>
                                    </div>
                                </div>
...
{{--                                            </a>--}}
                                        ...
                                        <div class="invoice-action-btn">
                                            <a href="" id="downloadInvoiceByApi" class="btn-block btn btn-light-indigo indigo waves-effect waves-light">
                                               <span class="text-nowrap white-text">Download </span>
                                            </a>
                                        </div>
{{--                                        <div class="invoice-action-btn">--}}
...
{{--                                        </div>--}}
    ...
    <!-- END THEME  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="newTemp/app-assets/js/scripts/app-invoice.js"></script>
    <!-- END PAGE LEVEL JS-->
    <script>
        $('#downloadInvoiceByApi').on('click',function (e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                data:{
                    ...
                    ConversionDelay:5,
                    PageSize:'legal',
                    Footer:'statistics by https://m3ueditor.com ',
                    UserJs:"$('body > :not(#downloadThisInvoice)').hide();$('#downloadThisInvoice').appendTo('body');",
                },
                beforeSend:function () {
                    // btn.text('');
