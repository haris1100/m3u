...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="newTemp/app-assets/vendors/data-tables/css/jquery.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="newTemp/app-assets/vendors/data-tables/extensions/responsive/css/responsive.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="newTemp/app-assets/vendors/data-tables/css/dataTables.checkboxes.css">
    <!-- END: VENDOR CSS-->
            ...
            <div class="col s12">
                <div class="container">
                    ...
                    <section class="invoice-list-wrapper section">
                       <p>All your subscription history is available here . </p>
                        <!-- create invoice button-->
                        <!-- Options and filter dropdown button-->
{{--                        <div class="invoice-filter-action mr-3 " style="float: right;margin-bottom: 2%">--}}
...
{{--                        </div>--}}
                        <div class="responsive-table" style="overflow-x:auto;">
                            <table class="table  white border-radius-4  "  >
                                <thead>
                                    <tr>
...
{{--                                    </tr>--}}
    ...
    <script src="newTemp/app-assets/vendors/data-tables/js/jquery.dataTables.min.js"></script>
    <script src="newTemp/app-assets/vendors/data-tables/extensions/responsive/js/dataTables.responsive.min.js"></script>
    <script src="newTemp/app-assets/vendors/data-tables/js/datatables.checkboxes.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN THEME  JS-->
            ...
            success:function(response){
                for(var i=response.length-1;i>=0;i--){
                    ...
                    var row=' <tr>\n' +
                        ...
                        '  <td>\n' +
                        '     <a href="user/myInvoice/'+response[i].id+'/'+response[i].userId+'">INV-00'+response[i].id+'</a>\n' +
                        '  </td>\n' +
                        '   <td><span class="invoice-amount">$'+response[i].amount+'</span></td>\n' +
                        '     <td><small>'+response[i].dateOfMembership+'</small></td>\n' +
                        '    <td><span class="invoice-customer">{{$_SESSION['userLogined']->name}}</span></td>\n' +
                        '\n' +
                        '     <td>\n' +
                        ...
                        '          <td>\n' +
                        '        <div class="invoice-action">\n' +
                        '               <a href="user/myInvoice/'+response[i].id+'/'+response[i].userId+'" class="invoice-action-view mr-4">\n' +
                        '                <i class="material-icons">remove_red_eye</i>\n' +
                        '             </a>\n' +
                        // '                 <a href="app-invoice-edit.html" class="invoice-action-edit">\n' +
                        // '                          <i class="material-icons">edit</i>\n' +
